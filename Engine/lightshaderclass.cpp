...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, Utils::Maths::Matrix worldMatrix, Utils::Maths::Matrix viewMatrix,
    Utils::Maths::Matrix projectionMatrix, ID3D11ShaderResourceView* texture, LightClass* light, Utils::Maths::Vector3 cameraPos)
{
	...
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, light, cameraPos);
	if(!result)
	{
		return false;
	}
    ...
    Utils::Maths::Matrix projectionMatrix, ID3D11ShaderResourceView* texture, LightClass* light, Utils::Maths::Vector3 cameraPos)
{
	...
	dataPtr2->position = light->GetPosition();
