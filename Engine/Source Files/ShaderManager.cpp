...
namespace Engine
{
    ...
    void ShaderManager::LoadCoreShaders()
    {
        ...
        // Load the Standard forward shaders
        {
            ...
            Shader::Ptr vertexShader = std::make_shared<Shader>(Shader::Type::Vertex, UberShader::g_VSMain, sizeof(UberShader::g_VSMain));
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, UberShader::g_PSMain, sizeof(UberShader::g_PSMain));
        ...
        // Load deep G-Buffer generation shaders
        {
            ...
            Shader::Ptr vertexShader = std::make_shared<Shader>(Shader::Type::Vertex, DeepGBuffer::g_VSMain, sizeof(DeepGBuffer::g_VSMain));
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, DeepGBuffer::g_PSMain, sizeof(DeepGBuffer::g_PSMain));
            Shader::Ptr geometryShader = std::make_shared<Shader>(Shader::Type::Geometry, DeepGBuffer::g_GSMain, sizeof(DeepGBuffer::g_GSMain));
        ...
        // Load Shadow map shader
        {
            ...
            Shader::Ptr vertexShader = std::make_shared<Shader>(Shader::Type::Vertex, ShadowMapping::g_VSMain, sizeof(ShadowMapping::g_VSMain));
        ...
        Shader::Ptr fullScreenQuadVS = std::make_shared<Shader>(Shader::Type::Vertex, FullScreenQuad::g_VSMain, sizeof(FullScreenQuad::g_VSMain));

        // Load the post process deferred shaders
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, Deferred::g_PSMain, sizeof(Deferred::g_PSMain));
        ...
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, csZCopy::g_PSMain, sizeof(csZCopy::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
        ...
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, Minify_CSZ::g_PSMain, sizeof(Minify_CSZ::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
        ...
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, Minify_Lambertian::g_PSMain, sizeof(Minify_Lambertian::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
        ...
        // Load the AO shader
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, AO::g_PSMain, sizeof(AO::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
        ...
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, BilateralBlurSampled::g_PSMain, sizeof(BilateralBlurSampled::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
        ...
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, BilateralBlurPacked::g_PSMain, sizeof(BilateralBlurPacked::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
        ...
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, TSAA::g_PSMain, sizeof(TSAA::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
        ...
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, BasicTemporalFilter::g_PSMain, sizeof(BasicTemporalFilter::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
        ...
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, LambertianOnly::g_PSMain, sizeof(LambertianOnly::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
        ...
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, ComputeRadiosity::g_PSMain, sizeof(ComputeRadiosity::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
        ...
        {
            Shader::Ptr pixelShader = std::make_shared<Shader>(Shader::Type::Pixel, Tonemap::g_PSMain, sizeof(Tonemap::g_PSMain));
            ShaderPipeline::Ptr shaderPipeline = std::make_shared<ShaderPipeline>(fullscreenQuadLayout, fullScreenQuadVS, pixelShader);
