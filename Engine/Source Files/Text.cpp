...
namespace Engine
{
    ...
    bool Text::Render(ID3D11DeviceContext* deviceContext, FontShader* FontShader, Utils::Maths::Matrix worldMatrix, Utils::Maths::Matrix orthoMatrix)
    {
        bool result;
    ...
    bool Text::RenderSentence(SentenceType* sentence, ID3D11DeviceContext* deviceContext, FontShader* FontShader, Utils::Maths::Matrix worldMatrix,
