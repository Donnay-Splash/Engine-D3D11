...
namespace Engine
{
    ...
    public:
        ...
        void GatherLights(Scene::Ptr scene, ID3D12GraphicsCommandList* commandList, LightSpaceModifier space = LightSpaceModifier::World);
        ...
        Utils::Maths::Matrix RenderShadowMap(Light::Ptr shadowCaster, ID3D12GraphicsCommandList* commandList);
