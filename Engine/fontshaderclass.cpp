...
bool FontShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
    ...
    result = device->CreateVertexShader(FontShader::g_VSMain, sizeof(FontShader::g_VSMain), NULL, &m_vertexShader);
	if(FAILED(result))
	{
		return false;
	}
    ...
    // Create the vertex shader from the buffer.
    result = device->CreatePixelShader(FontShader::g_PSMain, sizeof(FontShader::g_PSMain), NULL, &m_pixelShader);
	if(FAILED(result))
	{
		return false;
	}
